...
for(i in 1:length(args)) {
  if (file.exists(args[i])) {
    ...
    ydetail <- paste(sep="", "\n(sliding window of size ", window, " bp, step size ", window, " bp)")
